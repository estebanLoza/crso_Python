...
print(
    f"La modificacion de la Clase es: {persona1.nombre} {persona1.apellido} {persona1.edad}"
)
...
print(
    f"La modificacion de la CLASE 2 es: {persona2.nombre} {persona2.apellido} {persona2.edad}"
)
